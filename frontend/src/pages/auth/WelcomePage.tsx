...
const translations = {
  ...
  ta: {
    ...
    description: 'இந்த அமைப்பு செயல்படுகிறது: கணக்கு குறியீடுகள் இல்லாமல், கணக்கு விளக்கப்படம் இல்லாமல், இதழ் பதிவுகள் இல்லாமல், நிதியாண்டு முடிவுகள் இல்லாமல், நிதி காலங்கள் இல்லாமல். காலவரையன்றி. இயற்கை நபர் மற்றும் சட்ட நிறுவனம் இடையே வேறுபடுத்த தேவையில்லை',
  ...
  ur: {
    subtitle: 'کثیر القومی اکاؤنٹنگ کے لیے جامع حل',
    description: 'آپ کی اکاؤنٹنگ کے انتظام کے لیے طاقتور پلیٹ فارم متعدد زبانوں، کرنسیوں اور بین الاقوامی رپورٹنگ معیارات کی معاونت کے ساتھ۔',
    welcome: 'خوش آمدید'
  },
  vi: {
    subtitle: 'Giải pháp toàn diện cho kế toán đa quốc gia',
    description: 'Nền tảng mạnh mẽ để quản lý kế toán của bạn với hỗ trợ nhiều ngôn ngữ, đơn vị tiền tệ và tiêu chuẩn báo cáo quốc tế.',
    welcome: 'Chào mừng'
  }
}
