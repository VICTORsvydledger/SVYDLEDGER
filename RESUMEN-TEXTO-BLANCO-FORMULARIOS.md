...
- ? **Bot�n PAY:** `color: white` (antes #000)
...
- ? **T�tulo del header:** `color: white` (antes #000)
- ? **Botones de acci�n:**
...
- ? **Celdas de tabla:**
  ...
  - Tambi�n en filas seleccionadas: `color: white`
...
- ? **"Solo el administrador puede editar este bloque":**
  ...
  - A�adida sombra negra para legibilidad: `text-shadow: 0 0 5px rgba(0, 0, 0, 0.7)`
...
|--------|----------------------------|
| **Bloque 1** | Header, Labels, Inputs, Placeholder, Bot�n PAY, Minimum payment |
| **Bloque 2** | T�tulo, 5 botones de acci�n, Headers de tabla (3), Todas las celdas |
...
2. **Mensaje de administrador:**
   - `text-shadow: 0 0 5px rgba(0, 0, 0, 0.7)` (sombra negra m�s fuerte)
...
| Borde de bloques | 4px s�lido blanco |
